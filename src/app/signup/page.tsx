...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        // Auto-redirect to dashboard if email verification is off, otherwise they stay to read message
    }
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100 dark:border-gray-700">
                    <form className="space-y-6" onSubmit={handleSignup}>
                        ...
                        {message && (
                            <div className="bg-green-50 dark:bg-green-900/30 text-green-700 dark:text-green-400 p-3 rounded-md text-sm border border-green-200 dark:border-green-800/50">
                                {message}
                            </div>
                        )}
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <button
                                ...
                                className="flex w-full justify-center items-center gap-3 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 py-2 px-4 text-sm font-medium text-gray-700 dark:text-white shadow-sm hover:bg-gray-50 dark:hover:bg-gray-600 transition"
                            >
